...
## Deployment Methods
---
1.  ***Get `SESSION ID` by [`SCANING QR`](https://badtech-md-vtsf.onrender.com/) Or [`PARING CODE`](https://badtech-md-vtsf.onrender.com/code). Then `Go-to Whatapp>Three dots>Linked Devices`***
2.  ***Get Mongodb_URI from [`Mongodb site`](https://www.mongodb.com/) | Watch Tutorial [`To Get Mongodb_URI`](https://youtu.be/4YEUtGlqkl4). `Optional`***
3.  ***Click [`FORK`](https://github.com/Badtechramadhan/BADTECH_MD/fork) and `Star ⭐ Repository` for Courage.***
4.  ***Deploy FREE on `Codespace,` First watch tutorial [`Codespace tutorial`](https://youtu.be/3NdJb6_1cJM)***
5.  ***Deploy on [`HEROKU`](https://Badtech-web01.vercel.app/deploy?platform=suhail).  `FIXED! ✔️`***
6.  ***Deploy on [`Replit`](https://Badtech-web01.vercel.app/deploy?platform=repl). ([Tutorial](https://youtu.be/hPXU9OjMryQ) )***
7.  ***Deploy on [`Railway`](https://Badtech-web01.vercel.app/deploy?platform=railway). ([Tutorial](https://youtu.be/iGVdsK4qmcc) )***
8.  ***Deploy on [`Koyeb`](https://Badtech-web01.vercel.app/deploy?platform=koyeb)***
9. ***Deploy on [`Glitch`](https://Badtech-web01.vercel.app/deploy?platform=glitch)***
10. ***Deploy on [`RENDER`](https://Badtech-web01.vercel.app/deploy?on=render)***
